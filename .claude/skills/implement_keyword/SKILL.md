...
Example keyword input can be found in test/gen_keywords/$ARGUMENTS.k
...
The steps required to implement the keyword are:
 ...
 2 Then run test/utils/file_splitter.py using the command 'python3 test/utils/file_splitter.py'
   This will create the file test/gen_keywords/$ARGUMENTS.k.
...
Do the following checks on the code.
 ...
 5 Look at both test/gen_keywords/$ARGUMENTS.k and dynakw/keywords/$ARGUMENTS.py and
