...
The input file to the test is stored in test/gen_keywords/<<KEYWORD>>.k
...
If the user asks to see the original input then display test/gen_keywords/<<KEYWORD>>.k,
